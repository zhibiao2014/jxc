 ...
 * ============================================================================
 * $Author: liuhui $
 * $Id: lib_common.php 17146 2016-04-29 06:20:43Z liuhui $
*/
...
function get_package_goods($package_id, $package_attr_id='')
{
    ...
    $sql = "SELECT pg.goods_id, g.goods_name, pg.goods_number, p.goods_attr, p.product_number, p.product_id
            ...
            WHERE pg.package_id = '$package_id' $sql_package_attr_id "; //有修改 by uppschina.com 注意最后那个 $sql_package_attr_id
    if ($package_id == 0)
    {

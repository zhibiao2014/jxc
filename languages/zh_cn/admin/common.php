 ...
 * ============================================================================
 * $Author: luozhibiao $
 * $Id: common.php 17217 2011-01-19 06:29:08Z luozhibiao $
 */
$_LANG['app_name'] = 'ECSHOP';
$_LANG['cp_home'] = '庆丰裕 管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2008-2016 深圳庆丰裕，并保留所有权利。';
...
$_LANG['17_weixin_manage'] = '微信模块'; // 增加 by uppschina.com 微商城
...
$_LANG['price_batch'] = '批量修改价格'; // 代码增加 By uppschina.com
$_LANG['article_auto'] = '文章自动发布';
$_LANG['navigator'] = '自定义导航栏';
/* 虚拟团购 代码增加 by uppschina.com start */
...
/* 虚拟团购 代码增加 by uppschina.com end */
...
/* 代码添加_START By uppschina.com */
$_LANG['keyword'] = '客户搜索记录';
/* 代码添加_END By uppschina.com */
...
$_LANG['04_users_export'] = '会员导出'; // 代码增加 By uppschina.com
...
/* 代码增加_end By supplier.68ecshop.com */
// 微信管理 增加 start by uppschina.com 微商城

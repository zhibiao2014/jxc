 ...
 * ============================================================================
 * $Author: luozhibiao $
 * $Id: cls_sql_dump.php 17217 2011-01-19 06:29:08Z luozhibiao $
*/
...
class cls_sql_dump
{
     ...
     */
    public static function get_head($path)  //代码修改   By    uppschina.com   增加 public static
    {
        /* 获取sql文件头部信息 */
     ...
     */
    public static function get_random_name()  //代码修改   By    uppschina.com
    {
        $str = date('Ymd');

 ...
 * ==========================================================
 * $Author: luozhibiao $
 * $Id: magazine_list.php 17217 2011-01-19 06:29:08Z luozhibiao $
 */
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    if (empty($_POST['step']))
    {
        ...
        $smarty->assign('action_link', array('text' => $_LANG['go_list'], 'href' => 'magazine_list.php?act=list'));
         create_html_editor('magazine_content', htmlspecialchars($rt['template_content'])); /* 修改 by uppschina.com 百度编辑器 */
        assign_query_info();
        $smarty->display('magazine_list_add.htm');
    }
    elseif ($_POST['step'] == 2)

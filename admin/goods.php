 ...
 * ============================================================================
 * $Author: luozhibiao $
 * $Id: goods.php 17217 2011-01-19 06:29:08Z luozhibiao $
*/
...
require_once(ROOT_PATH . '/' . ADMIN_PATH. "/nusoap/nusoap.php");   //代码增加  By  uppschina.com
...
{
     /* 修改 by uppschina.com 百度编辑器 begin */
    //include_once(ROOT_PATH . 'includes/fckeditor/fckeditor.php'); // 包含 html editor 类文件
    /* 修改 by uppschina.com 百度编辑器 end */

	// 代码增加_start_derek20150129admin_goods  uppschina.com

	include_once(ROOT_PATH . '/includes/Pinyin.php');

	// 代码增加_end_derek20150129admin_goods  uppschina.com
    ...
    if ($is_add)
    {
        ...
        $goods = array(
            ...
            'warn_number'   => 1,
            /* 代码修改 By  uppschina.com 促销商品时间精确到时分 Start */
...
//            'promote_end_date'   => local_date('Y-m-d', local_strtotime('+1 month')),
            ...
            /* 代码修改 By  uppschina.com 促销商品时间精确到时分 End */
...
//            $goods['promote_end_date'] = local_date('Y-m-d', $goods['promote_end_date']);
    ...
    /* 创建 html editor */
    create_html_editor('goods_desc', htmlspecialchars($goods['goods_desc'])); /* 修改 by uppschina.com 百度编辑器 */

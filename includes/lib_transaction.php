 ...
 * ============================================================================
 * $Author: luozhibiao $
 * $Id: lib_transaction.php 17217 2011-01-19 06:29:08Z luozhibiao $
*/
...
function get_user_orders($user_id, $num = 10, $start = 0)
{
    ...
    $sql = "SELECT order_id, order_sn, order_status, shipping_status, pay_status, add_time, shipping_time," .
			" supplier_id, rebate_id, parent_order_id,	  ". //代码增加  By  uppschina.com
    ...
    while ($row = $GLOBALS['db']->fetchRow($res))
    {
        ...
        $arr[] = array('order_id'       => $row['order_id'],
			...
			'is_suborder' => $row['parent_order_id'] ? "(子订单)" : "",  //代码增加   By  uppschina.com
                       'handler'        => $row['handler']);		

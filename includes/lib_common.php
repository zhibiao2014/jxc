 ...
 * ============================================================================
 * $Author: luozhibiao $
 * $Id: lib_common.php 17217 2011-01-19 06:29:08Z luozhibiao $
*/
...
//         $arr['ww']                   = !empty($arr['ww']) ? $arr['ww'] : '';
        ...
        /* fulltext_search_add_START_uppschina.com */
	$arr['fulltext_search']            = isset($arr['fulltext_search']) ? $arr['fulltext_search'] : 0;  
        /* fulltext_search_add_END_uppschina.com */
 ...
 */
// 代码修改_start_derek20150129admin_goods  uppschina.com
function get_brand_list($t = false)
// 代码修改_end_derek20150129admin_goods  uppschina.com
{
...
/**
 *  清除手机指定后缀的模板缓存或编译文件
 *  wei2 增加 start by uppschina.com
 * @access  public
 * @param  bool       $is_cache  是否清除缓存还是清出编译文件
 * @param  string     $ext       需要删除的文件名，不包含后缀
 *
...
function get_package_goods($package_id, $package_attr_id='')
{
	...
	if ($package_attr_id)
	{
	 ...
	 // 下面SQL语句增加两个字段，注意逗号 , g.goods_thumb, g.shop_price   By  uppschina.com
...
function Recordkeyword($word_www_68ecshop_com, $items = 0, $searchengine = 'ecshop')
{
	...
	if($r)
	{
		$items = intval($items) ;   //uppschina.com
